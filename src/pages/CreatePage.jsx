...
const CreatePage = () => {
    ...
    return (
        <div
            className="relative mx-auto w-full max-w-md bg-white dark:bg-gray-800 mt-10 px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 dark:ring-gray-700 rounded-2xl sm:px-10">
            <div className="w-full">
                <div className="text-center">
                    <h1 className="text-3xl font-semibold text-gray-900 dark:text-white">Create Event</h1>
                    <p className="mt-2 text-gray-500 dark:text-gray-400">Please fill form below to create your
                        event.</p>
                </div>
                <div className="mt-5">
                    ...
                    <div className="mt-6">
                        <button
                            onClick={create}
                            className="w-full font-bold cursor-pointer rounded-xl bg-rose-500 px-3 py-4 text-white hover:bg-rose-600 transition">
                            Create
                        </button>
                    </div>
