...
const Toolbar = () => {
    ...
    return (
        <>
            {loggedUser &&
            <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8 border-b border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-1 items-center justify-end md:justify-between">
                    <nav className="hidden md:block">
                        <ul className="flex items-center gap-3 text-sm font-medium">
                            <li>
                                <Link className="transition py-2 px-4 rounded-2xl hover:bg-rose-200 dark:hover:bg-rose-800" to={"/create"}>
                                    Create Event
                                </Link>
                            </li>

                            <li>
                                <Link className="transition py-2 px-4 rounded-2xl hover:bg-rose-200 dark:hover:bg-rose-800" to={"/myEvents"}>
                                    Your Events
                                </Link>
                            </li>

                            <li>
                                <Link className="transition py-2 px-4 rounded-2xl hover:bg-rose-200 dark:hover:bg-rose-800" to={"/favorites"}>
                                    Favorites
                                </Link>
                            </li>
                        </ul>
